...
function help_dashboard_widget_function() {
	...
	echo '
		...
		<ul style="width:40%;float:left;min-width:153px;">
			...
			<li><a href="http://youtu.be/6xi3FBJpiP0" target="_blank">Homepage Settings &amp; Other Pages</a></li>
			<li><a href="http://youtu.be/ul38YGZcnJQ" target="_blank">Managing the Photo Gallery</a></li>
			<li><a href="http://youtu.be/CXEoWf9rJE8" target="_blank">Managing the Giving Page</a></li>
			<li><a href="http://youtu.be/pWe_lJ6KKaY" target="_blank">Easily Create Paypal Buttons</a></li>
			<li><a href="http://www.youtube.com/watch?v=brMy0BFwxxc" target="_blank">Testimonies, News Feed &amp; Free Thinking</a></li>
